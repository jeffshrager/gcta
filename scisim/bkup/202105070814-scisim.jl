...
effect_modelfmt(effect_model) = string(map(m->@sprintf("%s",m[1]),effect_model))
...
function test(;test=:fast,n=50,otheroverrides=[])
    if test==:xcelsior
        ...
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false]],color="green",label="xCelsior")
    elseif test==:gctaall
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,true],[:policy,:standard]],color="magenta",label="Trials as Usual")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false],[:policy,:standard]],color="red",label="xCelsior")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false],[:policy,:GCTA]],color="green",label="GCTA")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false],[:policy,:contrarian]],color="orange",label="Contrarian")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false],[:policy,:revGCTA]],color="blue",label="revGCTA")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false],[:policy,:anydrug]],color="black",label="Any Drug")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.05,n=n,otheroverrides=[[:trialsp,false],[:policy,:popularity]],color="brown",label="Popularity")
    elseif test==:gctaxtxpervarlimit
        run(:txs_per_variant_limit,1,10,2,n=n,otheroverrides=[[:trialsp,false],[:tx_effect_size_mean_for_positive_variant,0.8],[:policy,:standard]],color="red",label="xCelsior")
        run(:txs_per_variant_limit,1,10,2,n=n,otheroverrides=[[:trialsp,false],[:tx_effect_size_mean_for_positive_variant,0.8],[:policy,:GCTA]],color="green",label="GCTA")
        run(:txs_per_variant_limit,1,10,2,n=n,otheroverrides=[[:trialsp,false],[:tx_effect_size_mean_for_positive_variant,0.8],[:policy,:revGCTA]],color="blue",label="revGCTA")
    ...
    elseif test==:fast # For fast testing
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,true],[:policy,:standard]],color="magenta",label="Trials as Usual")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,false],[:policy,:standard]],color="red",label="xCelsior")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,false],[:policy,:GCTA]],color="green",label="GCTA")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,false],[:policy,:contrarian]],color="orange",label="Contrarian")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,false],[:policy,:revGCTA]],color="blue",label="revGCTA")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,false],[:policy,:anydrug]],color="black",label="Any Drug")
        run(:tx_effect_size_mean_for_positive_variant,0.0,0.8,0.1,n=10,otheroverrides=[[:trialsp,false],[:policy,:popularity]],color="brown",label="Popularity")
    end
end

#simrun(contextdict=Dict(:overkey=>"Test"))
test(test=:gctaxtxpervarlimit, n=100)
