...
transformed parameters {
  ...
  sigma_eps_tl = invcdf_cauchy(s_eps_tl, 0.0, scale_eps_tl);
...
model {
  ...
  // ###############################################################################################
  // 
  //   Noise parameters (sigma_eps_*, sigma_u) are implicitly drawn from a cauchy distribution
  //   by transforming a uniformly distributed parameter with the Cauchy inverse CDF.
  // 
