    ...
    def run(self, settings_obj_num):
        ...
        for k in range(self.settings.param("trial-n")):
            ...
            with g.as_default():
                ...
                print('On trial', str(k+1), 'of experiment configuration', str(settings_obj_num) + '.')
...
class Framework:
    def __init__(self, path_to_param_file):
        ...
        self.data_file = open('experiments/'+self.run_label+'/'+self.data_name, 'r')
...
def main():
    frame = Framework('parameters.json')
