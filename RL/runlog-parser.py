...
#'random_background_shift', 'ts',  'results', 'random_training_shift', 'trial_n', 'num_training_cycles', 'num_training_samples'
#'stretch_training_divisor', 'dim_of_input', 'random_background_multiplier', 'stretch_training_shift', 'training_constant', 
#'background_constant', 'random_training_multiplier', 'mean_results', 'test_fraction', 'background_mode', 'bias_val'
#'testing_length', 'delta_k_training_inclusion_abs_threshold', 'delta_k_testing_inclusion_abs_threshold', 'training_length'
fields = ['best-accuracy', 'mean-results', 'training-length', 'testing-length', 'results'] 
csvw = CSVWriter('classifier-results.json', 'data.csv', fields)
csvw.build_csv()
